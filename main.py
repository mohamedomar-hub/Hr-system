...
# ✅ AM/DM gets Report Compliance + IDB + Self Development
pages = ["My Profile", "📋 Report Compliance", "🚀 IDB – Individual Development Blueprint", "🌱 Self Development", "Ask HR", "Request HR", "Notifications", "Structure", "Salary Monthly"]
elif is_mr:
